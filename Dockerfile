...
curl \
	--silent \
	--output /var/tmp/tixati.deb https://download2.tixati.com/download/tixati_3.11-1_amd64.deb && \
export TERM=vt100 && \
add-pkg /var/tmp/tixati.deb && \
sed-patch \
	's/<application type="normal">/<application type="normal" title="Tixati v3.11">/' \
